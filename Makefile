...
run: build
	DD_TRACE_SAMPLE_RATE=1 DD_SERVICE=notes DD_ENV=nappyLappy DD_VERSION=0.0.1 ./cmd/notes/notes &
	DD_TRACE_SAMPLE_RATE=1 DD_SERVICE=calendar DD_ENV=nappyLappy DD_VERSION=0.0.1 ./cmd/calendar/calendar &
